            ...
            <div class="card border-0">
                <div class="card-header bg-white py-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            @else
                                {{-- If you are not the owner of the post, show Follow/Unfollow button. Will be discussed soon --}}
                ...
                <div class="card-body w-100">
                   {{-- heart button + no. of likes + categories --}}
                    ...
                    <a href="{{ $post->user->id }}" class="text-decoration-none text-dark fw-bold">{{ $post->user->name }}</a>
                    &nbsp;
                    <p class="d-inline fw-light">{{ $post->description }}</p>
                    <p class="text-uppercase text-muted xsmall">{{ date('M d, Y', strtotime($post->created_at)) }}</p>

                        {{-- 
                            strtotime()   -- builtin function in PHP
                            strtotime($post->created_at); 2024-11-12 07:46:08 --> 1756752428811
                            date('M d, Y', 1756752428811)
                            date(NOV 12, 2024)
