        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="post">
            ...
            <div class="modal-content border-warning">
                ...
                <div class="modal-footer border-0">
                    ...
                    <button class="submit btn btn-warning btn-sm">Update</button>
                </div>
            </div>
        </form>
    </div>
        ...
        <form action="{{ route('admin.categories.destroy', $category->id) }}" method="post">
            ...
            <div class="modal-content border-danger">
                ...
                <div class="modal-body">
                    ...
                    <p class="fw-light">This action will affect all the posts under this category. Post without category will fall under <span class="fw-bold">"Uncategorized"</span></p>
                </div>
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">Cancel</button>
                    <button class="submit btn btn-danger btn-sm">Delete</button>
                </div>
            </div>
        </form>
    </div>
